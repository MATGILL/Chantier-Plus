...
class ResourceService {
  ...
  Future<ServiceResult<List<Supply>>> getAvailableSupply(
      HalfDay halfDayBeginning,
      DateTime startingDate,
      int durationInDays) async {
    return await _repository.getAvailableSupplyrPeriod(
        halfDayBeginning, startingDate, durationInDays);
  }

  Future<ServiceResult<List<Vehicle>>> getAvailableVehicle(
      HalfDay halfDayBeginning,
      DateTime startingDate,
      int durationInDays) async {
    return await _repository.getAvailableVehicleForPeriod(
        halfDayBeginning, startingDate, durationInDays);
  }
}
